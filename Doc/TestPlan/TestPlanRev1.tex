...
\rev{Initial State: Active Menu State}
					
\rev{Input/Condition: N/A}
					
\rev{Output/Result: N/A}
					
\rev{How test will be performed: The developers will ensure that there are no aspects within the game that may be offensive to different cultures, and that the game will be non-partisan.}

\item{\rev{Security Requirements Testing}:}\

\rev{Type: Manual}
					
\rev{Initial State: Active Menu State}
					
\rev{Input/Condition: All User Inputs}
					
\rev{Output/Result: N/A}
					
\rev{How test will be performed: The developers will move through the different states of the game, attempting to break the game through the use of all the user inputs}
